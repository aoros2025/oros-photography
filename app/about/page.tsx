    ...
    <>
        ...
        <div className="section" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          ...
          <div>
            ...
            <h1 style={{ fontStyle: 'italic', marginBottom: '24px' }}>
              I'm Angel, a portrait photographer based in Pittsburgh.
            </h1>
            <h3 style={{ fontFamily: 'var(--sans)', fontWeight: 500, fontSize: '13px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--mid)', marginBottom: '20px' }}>
              I pick up my camera to help people see themselves differently
            </h3>
            <p style={{ marginBottom: '16px' }}>
              I'm a Pittsburgh-based portrait photographer with a passion for helping people show up confidently in their professional lives.
            </p>
            <p style={{ marginBottom: '32px' }}>
              Whether you're a student stepping into your career, a professional refreshing your image, or a creative building your brand, I believe great photos can open doors — and I'm here to help you walk through them.
            </p>
      ...
      <section style={{ background: 'var(--off-white)', borderBottom: '1px solid var(--light)' }}>
        <div className="section">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px', background: 'var(--light)' }}>
            {[
              { num: '01', title: 'The dogs made me do it', body: 'I share my home in Verona with my partner Patrick and our two dogs, Jar Jar and Zina. They\'ve appeared in more test shots than I\'d like to admit.' },
              ...
              { num: '04', title: 'It started personal', body: 'I got into photography because I know what it feels like to not have a single photo you actually like of yourself. That\'s what I\'m here to fix.' },
            ].map((item) => (
      ...
      <section>
        <div className="section">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2px' }}>
            <div className="img-placeholder" style={{ aspectRatio: '16/10' }}>[ gallery image 1 ]</div>
            <div className="img-placeholder" style={{ aspectRatio: '3/4' }}>[ gallery image 2 ]</div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: 'var(--off-white)', borderTop: '1px solid var(--light)' }}>
        <div className="section" style={{ textAlign: 'center', maxWidth: '560px', margin: '0 auto' }}>
          <h2 style={{ fontStyle: 'italic', marginBottom: '20px' }}>Let's work together.</h2>
          <p style={{ marginBottom: '32px' }}>Ready to get photos you're actually proud of?</p>
